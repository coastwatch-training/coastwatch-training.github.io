...
|--------------------------|---------------------|-----------------------------------------------------------------------------------------------------------------------|---------------------|
| **Day 1 - February 10**    | 9:00 AM  (live session)            | Introduction to [NOAA CoastWatch](https://drive.google.com/file/d/13dpKOrBVv8C0SNuc1c4d6SV3n1EIy89k/view?usp=share_link) & [PacIOOS](https://drive.google.com/file/d/136NbhZHBLQeXzzTSf5OBn7ouemVzGdSg/view?usp=sharing)                                                                             |  Daisy Shi & Lauren Kaiser   |
...
|                          |                      | Tutorial 1: [ERDDAP Basics](https://github.com/coastwatch-training/coastwatch-training.github.io/tree/main/tutorials/ERDDAP-Basics)                                                                                                                |                     |
|                          |                      | Tutorial 2: [PacIOOS Voyager User Tutorial](https://youtu.be/7-r941-f78I)                                                                                                                 |                     |
|                          |                      | Optional Tutorial: [MATLAB, R, or Python](https://github.com/coastwatch-training/coastwatch-training.github.io/tree/main/tutorials/Tutorial1-basics)                                                                                                                 |                     |
...
|                          |                    | MATLAB, R, or Python Tutorials: [Comparison of chlorophyll data from different sensors](https://github.com/coastwatch-training/coastwatch-training.github.io/tree/main/tutorials/Tutorial2-timeseries-compare-sensors)                                                                                                              |                     |
...
|                          |                    | MATLAB, R, or Python Tutorial: [Match satellite data to track locations](https://github.com/coastwatch-training/coastwatch-training.github.io/tree/main/tutorials/matchup-satellite-data-to-track-locations)                                                                                                                 |                     |
