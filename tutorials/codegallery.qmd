...
<div class="cg-filters">
  <div class="cg-filter-group">
    <label for="cg-category"><strong>Category</strong></label>
  ...
  <div class="cg-filter-group">
    ...
    <label class="cg-filter-check"><input id="cg-soft-py" type="checkbox"> Python</label>
    <label class="cg-filter-check"><input id="cg-soft-r" type="checkbox"> R</label>
    <label class="cg-filter-check"><input id="cg-soft-m" type="checkbox"> Matlab</label>
  </div>
...
function cgApplyFilters(){
  ...
  const wantPy = document.getElementById("cg-soft-py")?.checked || false;
  const wantR  = document.getElementById("cg-soft-r")?.checked || false;
  const wantM  = document.getElementById("cg-soft-m")?.checked || false;

  // If no software boxes are checked, treat as "all software"
  const softwareActive = wantPy || wantR || wantM;
...
document.addEventListener("change", (e) => {
  if(!e.target) return;
  const ids = ["cg-category","cg-soft-py","cg-soft-r","cg-soft-m"];
